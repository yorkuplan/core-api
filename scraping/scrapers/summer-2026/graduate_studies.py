"""Graduate Studies summer 2026 course timetable scraper."""
...
def main():
    ...
    html_path = scraping_dir / "page_source" / "summer-2026" / "graduate_studies.html"
    data_path = scraping_dir / "data" / "summer-2026" / "graduate_studies.json"
