...
MODULE_PATH = SCRAPERS_DIR / "summer-2026" / "schulich.py"
spec = importlib.util.spec_from_file_location("schulich", MODULE_PATH)
schulich = importlib.util.module_from_spec(spec)
spec.loader.exec_module(schulich)
